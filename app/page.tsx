      ...
      <div className="flex items-center justify-center p-8">
        <div className="bg-[#fff] rounded-lg p-12">
          ...
          <div className="grid grid-cols-3 gap-10">
            <Link href="/register">
              <button className="w-full min-w-[280px] px-16 py-12 bg-[#6487AF] text-white text-2xl font-bold rounded-md hover:bg-[#5476a0] active:bg-[#4465a0] transition-colors shadow-sm">
                登録画面
              </button>
            </Link>
