    ...
    <div className="min-h-screen bg-[#c0c0c0] p-8 font-sans flex items-center justify-center">
      <div className="bg-[#c0c0c0] border-2 border-white border-t-[#ffffff] border-l-[#ffffff] border-b-[#808080] border-r-[#808080] p-12">
        ...
        <div className="grid grid-cols-2 gap-10">
          <Link href="/register">
            <button className="w-full min-w-[280px] border-2 border-[#ffffff] border-t-[#ffffff] border-l-[#ffffff] border-b-[#808080] border-r-[#808080] px-16 py-12 bg-[#c0c0c0] text-2xl font-bold active:border-t-[#808080] active:border-l-[#808080] active:border-b-[#ffffff] active:border-r-[#ffffff] hover:bg-[#d0d0d0] transition-colors">
              登録画面
            </button>
          </Link>
