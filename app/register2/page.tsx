        ...
        <div className="p-4 space-y-4">
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="flex items-center gap-2">
              <label className="text-sm whitespace-nowrap">製品名</label>
              <select
                value={formData.製品名}
                onChange={(e) => setFormData({ ...formData, 製品名: e.target.value })}
                className="px-2 py-1 border-2 border-[#808080] border-t-[#000000] border-l-[#000000] border-b-[#ffffff] border-r-[#ffffff] bg-white text-sm w-48"
              >
            ...
            <div className="flex items-center gap-2">
              <label className="text-sm whitespace-nowrap">種類</label>
              <select
                value={formData.種類}
            ...
            <button
              ...
              className="ml-auto border-2 border-[#ffffff] border-t-[#ffffff] border-l-[#ffffff] border-b-[#808080] border-r-[#808080] px-6 py-1 bg-[#c0c0c0] text-sm active:border-t-[#808080] active:border-l-[#808080] active:border-b-[#ffffff] active:border-r-[#ffffff]"
            >
              仕様変更
            </button>
          </div>
          ...
          <div className="grid grid-cols-3 gap-x-6 gap-y-3">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">開口切詰 左:</label>
                <select
                  value={formData.開口切詰左}
                  onChange={(e) => setFormData({ ...formData, 開口切詰左: e.target.value })}
                  className="flex-1 px-2 py-1 border-2 border-[#808080] border-t-[#000000] border-l-[#000000] border-b-[#ffffff] border-r-[#ffffff] bg-white text-sm"
                >
                  <option value=""></option>
                </select>
              </div>
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">開口切詰 右:</label>
                <select
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">開口切詰 中:</label>
                <select
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">前柱中追加:</label>
                <select
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">カスケード張レ:</label>
                <select
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">屋根の出寸法変更:</label>
                <select
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">屋根軒軒材変更:</label>
                <select
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">屋根妻面持出:</label>
                <select
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">妻開きドラーメン構造:</label>
                <select
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">特主シャッター下地:</label>
                <select
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">軒高切詰:</label>
                <select
                  value={formData.軒高切詰}
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">前入隅 左:</label>
                <select
                  value={formData.前入隅左}
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">前入隅 右:</label>
                <select
                  value={formData.前入隅右}
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">後入隅 左:</label>
                <select
                  value={formData.後入隅左}
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">後入隅 右:</label>
                <select
                  value={formData.後入隅右}
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">種雷補強仕様:</label>
                <select
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">前出隅 左:</label>
                <select
                  value={formData.前出隅左}
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">前出隅 右:</label>
                <select
                  value={formData.前出隅右}
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">後出隅 左:</label>
                <select
                  value={formData.後出隅左}
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">後出隅 右:</label>
                <select
                  value={formData.後出隅右}
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">期途開高変更:</label>
                <select
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">長期地耐力:</label>
                <select
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">:</label>
                <select
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">水下シャッター下地:</label>
                <select
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">間仕切:</label>
                <select
                  value={formData.間仕切}
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">前壁:</label>
                <select
                  value={formData.前壁}
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">こりゃ工工床:</label>
                <select
              ...
              <div className="flex items-center gap-2">
                <label className="text-sm whitespace-nowrap w-32 flex-shrink-0">その他:</label>
                <select
                  value={formData.その他}
